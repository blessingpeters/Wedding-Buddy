    ...
    <>
      ...
      <section className="book relative font-lato">
        ...
        <img
          ...
          alt=""
        />
        <div className=" w-full md:w-[642px] mx-auto relative -top-32 bg-burgundy-100 text-white p-16 text-center">
          <h4>LETS MEET</h4>
          <button className="btn btn-outline btn-primary rounded-md my-10">
            Book a Vendor
          </button>
          <p>
      ...
      <section className="bg-[#FAF9F9] py-12 px-3">
        <form className="w-full md:w-3/5 mx-auto font-inter" action="">
          ...
          <button className="btn border-none w-full bg-burgundy-100 text-white text-lg rounded-md hover:bg-burgundy-50">Send</button>
        </form>
      </section>
      <Review />
    </>
