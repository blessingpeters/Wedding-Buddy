  ...
  return (
    <>
      <nav className="bg-burgundy-100/40 z-40">
        <div className="max-w-screen-2xl h-24 w-full flex flex-wrap items-center justify-between mx-auto lg:px-16 px-3 relative">
          <Link
            to="/"
          ...
          >
            <ul className="flex flex-col md:flex-row text-white font-inter">
              {menuItems.map((item, index) => (
                <li
                  key={index}
                  className="my-2 md:mx-4 lg:mx-8 hover:border-b border-white text-xl"
                >
              ...
              {dropdownItems.map((dropItem, dropIndex) => (
                <li key={`mobile-${dropIndex}`} className="md:hidden text-xl md:text-sm my-2">
