    ...
    <>
      ...
      <div className="w-full my-6">
          ...
          <input
            ...
            name="name"
            id="email"
            placeholder={`Enter your ${userType === 'vendor' ? 'company' : ''} email address`}
          />{" "}
          </div>
          ...
          <div className="my-6">
            ...
            <div className="relative">
              ...
              />{" "}
            <img className='absolute right-4 bottom-4 cursor-pointer' src="/assets/icons/eyeslash.svg" alt="eye slash icon" />
            </div>
